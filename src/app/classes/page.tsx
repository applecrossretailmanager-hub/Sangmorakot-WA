...
export default async function ClassesPage() {
  ...
  const { data: occurrences } = await supabase.rpc("get_class_occurrences", {
  ...
  for (const o of occurrences ?? []) {
    const list = byDay.get(o.class_date) ?? [];
    list.push(o);
    byDay.set(o.class_date, list);
  }
    ...
    <div className="container-page py-16">
      <div className="max-w-2xl mx-auto text-center mb-12">
        ...
        <p className="text-muted">
          Group Muay Thai classes for the next two weeks. Log in to reserve your spot — each
